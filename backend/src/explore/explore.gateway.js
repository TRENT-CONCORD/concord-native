...
exports.ExploreGateway = void 0;
const websockets_1 = require("@nestjs/websockets");
let ExploreGateway = (() => {
    let _classDecorators = [(0, websockets_1.WebSocketGateway)({ namespace: 'explore', cors: true })];
    ...
    var ExploreGateway = _classThis = class {
    ...
    __setFunctionName(_classThis, "ExploreGateway");
    (() => {
        ...
        ExploreGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ExploreGateway = _classThis;
})();
exports.ExploreGateway = ExploreGateway;
